...
<nav x-data="{ open: false }" class="bg-gradient-to-r from-[#A6B8DE] to-[#8BBBF8] border-b border-gray-100 py-4 md:py-0">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                        <img src="https://dishapatel126.github.io/hosted-assets/logo.png" class="block h-9 w-auto fill-current text-gray-800" />
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.developer')" :active="request()->routeIs('admin.developer')">
                        {{ __('Developers') }}
                    </x-nav-link> 
            </div>
        </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                ...
                <div class="font-medium text-sm text-gray-500">Name</div>
            </div>
